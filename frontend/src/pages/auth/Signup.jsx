          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {formData.role === 'faculty' && (
              <div className="space-y-1.5">
                ...
                <p className="mt-1 pl-1 text-[10px] font-semibold text-slate-400 uppercase tracking-widest italic">Optional for faculty</p>
              </div>
            )}
            ...
            {formData.role === 'hod' && (
              <div className="flex items-start gap-3 p-4 bg-amber-50 border border-amber-100 rounded-2xl">
                ...
                <p className="text-xs font-semibold text-amber-700 leading-relaxed">
                  Department assignment for HODs is managed by the Administrator after account creation.
                </p>
              </div>
            )}
